            ...
            try {
                ...
                switch (request.payload.type) {
                    ...
                    case 'MX':
                        ...
                        break;
                    case 'CAA':
                        value = [request.payload.value, request.payload.tags, request.payload.flags];
                        break;
                    case 'NS':
                ...
                let id = await zoneStore.add(request.params.zone, request.payload.subdomain, request.payload.type, value);
                return { id };
            } catch (err) {
                if (Boom.isBoom(err)) {
                    throw err;
            ...
            validate: {
                ...
                payload: Joi.object({
                    ...
                    tags: Joi.any()
                        ...
                        .description('Certificate authority tags for CAA')
                        .label('Tags'),
