    ...
    async deleteDomain(domain, type, value) {
        ...
        if (list && list.length) {
            for (let entry of list) {
                ...
                console.log('DEL', list, value, JSON.stringify(list.value), valueMatch, JSON.stringify(list.value) !== valueMatch);
                if (valueMatch && JSON.stringify(list.value) !== valueMatch) {
                    continue;
                }
